<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/logonav.png" alt="" /></a>
            <div class="container">
                     <!-- Aca esta el boton de Star Boostrap voy a poner un logo o algo
        ...
        <header class="masthead" id="home">
            <div class="container">
               ...
               <a class="btn btn-primary btn-xl btn-light " href="#contact">Solicitar Turno</a> 
                <div class="masthead-heading text-uppercase"></div>
            </div>
        </header>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">Limpieza Bucal</h4>
                    ...
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">Tratamientos Estéticos</h4>
     ...
     <section>
               <img src ="assets/img/covid.jpg" class="imgcovid">
     </section>
        ...
        <section class="page-section" id="contact">
            ...
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Solicitud de Turno para Atencion</h2>
                    <
                </div>
